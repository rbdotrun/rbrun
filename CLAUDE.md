...
- **CI equivalent:** `bin/rails db:test:prepare && bin/rails test` (two invocations — in Rails 8.1
  `test` is a command, not a rake task, so `bin/rails db:test:prepare test` errors)
