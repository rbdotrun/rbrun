...
class ServerTest < Minitest::Test
  def test_resolves_the_adapter_by_constant_lookup
    srv = Rbrun::Server.new(provider: :kamal_hetzner,
                            config: { hcloud_token: "t", registry: { server: "docker.io", username: "u", password: "pw" } })
  ...
  def test_base_methods_are_unimplemented_until_overridden
    ...
    assert_raises(NotImplementedError) { base.create_server(name: "x", type: "cx23", region: "fsn1", image: "ubuntu-24.04", ssh_public_key: "k") }
    ...
    assert_raises(NotImplementedError) { base.deploy(work_dir: "/tmp", host: "h", server_ip: "1.2.3.4", ssh_private_key: "p") }
  end
